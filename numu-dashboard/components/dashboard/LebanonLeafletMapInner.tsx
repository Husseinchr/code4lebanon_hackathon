...
export function LebanonLeafletMapInner({ regions }: { regions: RegionSummary[] }) {
  return (
    <div style={{ height: 390, border: "1px solid var(--border)", borderRadius: 14, overflow: "hidden" }}>
      <MapContainer
        ...
        {regions.map((item) => {
          ...
          return (
            <CircleMarker
              ...
              pathOptions={{ color: "#0e7490", fillColor: "#0891b2", fillOpacity: 0.75, weight: 2 }}
            >
              <Tooltip sticky>
                <div>
